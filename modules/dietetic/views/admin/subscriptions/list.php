                    ...
                    <div class="panel-body" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px; padding: 30px;">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <?php if (is_admin() || dietetic_has_permission('create')): ?>
                                            ...
                                            <tr class="subscription-row">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if ((is_admin() || dietetic_has_permission('edit')) && in_array($sub->status, ['trial', 'active', 'pending'])): ?>
                                                            <a href="<?php echo admin_url('dietetic/subscriptions/edit/' . $sub->id); ?>" class="btn btn-info btn-sm" title="Modifier">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                        <?php endif; ?>
                                                        <?php if ((is_admin() || dietetic_has_permission('delete')) && $sub->status != 'cancelled'): ?>
