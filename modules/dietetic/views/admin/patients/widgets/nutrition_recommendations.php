...
// Load nutrition calculator if not loaded
$CI = &get_instance();
if (!isset($CI->dietetic_nutrition_calculator)) {
...
if (!empty($patient->allergies)) {
    $health_alerts[] = [
        'type' => 'danger',
        'message' => 'ALLERGIES : ' . $patient->allergies . ' - Adapter le plan alimentaire en conséquence.'
    ];
}
