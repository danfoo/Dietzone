                    ...
                    <div class="panel-body">
                        ...
                        <?php if ($refund && $refund->status == 'pending'): ?>
                            <div class="alert alert-info">
                                ...
                                <strong><?php echo _l('refund_approval_confirmation'); ?></strong>
                                <p><?php echo _l('refund_approval_info_text'); ?></p>
                            </div>
                                    ...
                                    <table class="table table-bordered table-sm">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><strong class="text-success"><?php echo app_format_money($refund->refund_amount, $refund->currency); ?></strong></td>
                                            </tr>
                                            <tr>
                            ...
                            <!-- Approval Form -->
                            <?php echo form_open(admin_url('dietetic/refunds/approve/' . $refund->id)); ?>

                            <div class="form-group">
                                <label for="approval_notes"><?php echo _l('approval_notes'); ?></label>
                                <textarea name="approval_notes" id="approval_notes" class="form-control" rows="4" placeholder="<?php echo _l('approval_notes_placeholder'); ?>"></textarea>
                                <small class="text-muted"><?php echo _l('optional'); ?></small>
                            </div>

                            <div class="checkbox checkbox-primary">
                                <input type="checkbox" name="auto_process" id="auto_process" value="1" checked>
                                <label for="auto_process">
                                    <?php echo _l('auto_process_refund_after_approval'); ?>
                                </label>
                                <small class="text-muted block">
                                    <?php echo _l('auto_process_refund_help_text'); ?>
                                </small>
                            </div>
                            ...
                            <div class="btn-group">
                                <button type="submit" class="btn btn-success">
                                    <i class="fa fa-check"></i> <?php echo _l('approve_refund'); ?>
                                </button>
                        ...
                        <?php else: ?>
                            <div class="alert alert-danger">
                                ...
                                <?php echo _l('refund_cannot_be_approved'); ?>
                            </div>
