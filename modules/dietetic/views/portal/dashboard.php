...
.portal-program-status.active {
    background: #d4edda;
    color: #155724;
}

/* Meal Plan Card */
.portal-meal-plan-card {
    background: #f8f9fa;
    padding: 16px;
    border-radius: 6px;
    margin-bottom: 12px;
...
.portal-weight-chart-container h4 {
    margin: 0 0 16px 0;
    color: #333;
    font-size: 18px;
}
...
/* Consultation List */
.portal-consultation-list {
    list-style: none;
    padding: 0;
    margin: 0;
}

.portal-consultation-item {
    display: flex;
    justify-content: space-between;
    align-items: center;
    padding: 12px 0;
...
.portal-consultation-item:last-child {
    border-bottom: none;
}

.portal-consultation-date {
    font-weight: 600;
    color: #333;
}

.portal-consultation-type {
    font-size: 13px;
    color: #6c757d;
    margin-top: 4px;
}

.portal-consultation-status {
    font-size: 12px;
}
