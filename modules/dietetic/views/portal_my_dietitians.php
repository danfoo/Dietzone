        ...
        <div class="animate-in delay-1">
            ...
            <?php if (isset($specialties) && is_array($specialties) && count($specialties) > 0) { ?> {
                ...
                $specialty_descriptions = [
                    ...
                    'Nutrition de la femme' => 'Hormones, cycles et étapes de vie',
                    'Nutrition santé publique & collective' => 'Programmes pour communautés',
                    ...
                    <div class="criteria-ratings">
                        ...
                        <div class="criterion-item">
                            ...
                            <div class="criterion-stars">
                                <?php
                                for ($i = 1; $i <= 5; $i++) {
                                    echo $i <= $criterion_rounded ? '<i class="fa fa-star"></i>' : '<i class="fa fa-star-o"></i>';
                                }
                                ?>
                ...
                <div class="my-rating-section" id="myRatingDisplay">
                    ...
                    <div style="text-align: center;">
                        <div class="rating-stars" style="margin-bottom: 8px;">
                            ...
                            for ($i = 1; $i <= 5; $i++) {
                                echo $i <= $my_overall ? '<i class="fa fa-star"></i>' : '<i class="fa fa-star-o"></i>';
                            }
                            ?>
                        </div>
                        <div style="font-size: 14px; color: #6c757d; margin-bottom: 16px;">
                            Note globale: <?php echo number_format($my_rating->overall_rating, 1); ?>/5
                        </div>
                    </div>
                    ...
                    <div class="criteria-ratings">
                        ...
                        <div class="criterion-item">
                            ...
                            <div class="criterion-stars">
                                <?php
                                for ($i = 1; $i <= 5; $i++) {
                                    echo $i <= $my_score ? '<i class="fa fa-star"></i>' : '<i class="fa fa-star-o"></i>';
                                }
                                ?>
                    ...
                    <div style="margin-top: 12px; padding: 12px; background: white; border-radius: 8px;">
                        <div style="font-size: 13px; color: #6c757d; margin-bottom: 6px; font-weight: 600;">Votre commentaire :</div>
                ...
                <div class="my-rating-section" id="editRatingForm" style="display: none;">
                    ...
                    <form id="ratingForm" action="<?php echo site_url('dietetic/portal/rate_dietitian/' . $dietitian->staffid); ?>" method="post">
                        ...
                        <div style="display: flex; gap: 10px;">
                            <button type="submit" class="btn-submit-rating" id="submitRatingBtn" style="flex: 1;">
