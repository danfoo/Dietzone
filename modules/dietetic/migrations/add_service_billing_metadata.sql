...
-- =====================================================
-- Example: Insert default consultation service
-- =====================================================
INSERT INTO `tblitems` (
    ...
    'Consultation initiale avec anamnèse complète',
    25000.00,
    (SELECT id FROM tblitems_groups WHERE name = 'Services' LIMIT 1),
    'consultation',
    0,
    0
...
-- =====================================================
-- Example: Insert program services with discounts
-- =====================================================
INSERT INTO `tblitems` (
    `description`,
    `long_description`,
    ...
    `service_is_recurring`,
    `service_duration_months`,
    `service_discount_6_months`,
    `service_discount_12_months`
) VALUES
(
    'Suivi Nutrition Générale',
    'Programme complet de suivi nutritionnel personnalisé',
    50000.00,
    (SELECT id FROM tblitems_groups WHERE name = 'Services' LIMIT 1),
    'program',
    1,
...
(
    ...
    'Programme nutrition adapté aux sportifs',
    60000.00,
    (SELECT id FROM tblitems_groups WHERE name = 'Services' LIMIT 1),
    'program',
    1,
...
(
    'Suivi Diabète',
    'Programme nutrition pour diabétiques',
    55000.00,
    (SELECT id FROM tblitems_groups WHERE name = 'Services' LIMIT 1),
    'program',
    1,
